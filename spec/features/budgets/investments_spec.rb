...
describe "Budget Investments" do
  ...
  context "Selecting Phase" do
    ...
    scenario "It is only possible to support 3 investments per heading", :js do
      carabanchel = create(:budget_heading, group: group)

      investment_1 = create(:budget_investment, :feasible, heading: carabanchel)
      investment_2 = create(:budget_investment, :feasible, heading: carabanchel)
      investment_3 = create(:budget_investment, :feasible, heading: carabanchel)
      investment_4 = create(:budget_investment, :feasible, heading: carabanchel)

      login_as(author)
      visit budget_investments_path(budget, heading_id: carabanchel.id)

      within(".budget-investment", text: "In Carabanchel") do
        expect(page).to have_css(".in-favor a[data-confirm]", count: 4)
      end

      within("#budget_investment_#{investment_1.id}") do
        expect(page).not_to have_content "You have already supported this investment project. Share it!"

        click_link "Support"
        expect(page).to have_content "You have already supported this investment project. Share it!"
        expect(page).not_to have_content "You have already reached the maximum number of proposals you can support."
      end

      within("#budget_investment_#{investment_2.id}") do
        expect(page).not_to have_content "You have already supported this investment project. Share it!"
      ...
      within("#budget_investment_#{investment_3.id}") do
        expect(page).not_to have_content "You have already supported this investment project. Share it!"
      ...
      within("#budget_investment_#{investment_4.id}") do
        expect(page).not_to have_content "You have already supported this investment project. Share it!"

        click_link "Support"
        expect(page).to have_content "You have already reached the maximum number of proposals you can support."
        expect(page).not_to have_content "You have already supported this investment project. Share it!"
      end
